...
function VideoCall(props) {
  ...
  if (receivingCall) {
    incomingCall = (
      <div>
        ...
        <button className="btn btn-lg btn-primary" onClick={acceptCall}>Accept</button>
      </div>
    )
 ...
 let meetingEndButton;
  if(stream){
    meetingEndButton = (
      <button onClick = {() => disconnectMeeting()} className="btn btn-lg btn-danger" style={{cursor:'pointer',margin:40,marginLeft:300,marginTop:5}}>Disconnect</button>
    )
  }
